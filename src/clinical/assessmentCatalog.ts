...
export const ASSESSMENT_CATALOG: Record<AssessmentKey, AssessmentCatalogEntry> = {
  bdi: {
    ...
    period: 'Uygulanan yetkili Türkçe formun kendi yönergesini esas alın.',
    ...
    citation: 'Kimlik: Beck, Ward, Mendelson, Mock & Erbaugh (1961). Türkçe geçerlik/güvenirlik: Hisli (1988, 1989).',
  },
  bai: {
    key: 'bai',
    code: 'BAI',
