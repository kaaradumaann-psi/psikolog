...
create table if not exists public.test_definitions (
  ...
  source text not null default 'other' check (source in ('mmpi', 'other', 'beck', 'scl90', 'mmpi2', 'custom')),
...
values
  ('00000000-0000-4000-8000-000000000001', 'MMPI (Harici)', 'MMPI harici değerlendirme kaynağı — puanlama yeni sistemde yapılmaz, sadece özet ilişkilendirilir', 'mmpi', true),
  ('00000000-0000-4000-8000-000000000002', 'Beck Depresyon Ölçeği', 'Beck Depresyon Ölçeği — harici uygulama', 'beck', true),
  ('00000000-0000-4000-8000-000000000003', 'SCL-90-R', 'Semptom Tarama Listesi', 'scl90', true)
