...
## MMPI Integration
- [ ] No scoring/norms/questions copied — verified via code search
- [ ] test_definitions seed MMPI (Harici) only summary
- [ ] external_source="mmpi" + external_assessment_id pattern
- [ ] UI warns "puanlama bu sistemde yapılmaz"
