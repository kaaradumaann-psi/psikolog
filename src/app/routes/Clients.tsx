        ...
        <>
          ...
          {activeTab === 'testler' && (
            <div style={{ display: 'grid', gap: 16 }}>
              <div className="card">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                  <h3 style={{ fontSize: 14 }}>Yeni test uygulaması</h3>
                ...
                <div style={{ fontSize: 11, color: 'var(--muted)', marginTop: 8 }}>Not: Beck, BAI, SCL-90-R, GAD-7 ve PHQ-9 bu platformda puanlanır. Başka bir envanter yalnızca özet olarak kaydedilir.</div>
              </div>
